...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SOP-compliant Downloader for Wind Consensus Rating.")
    parser.add_argument('--trade-date', type=str, help='The trade date to process, format YYYYMMDD. Defaults to today.')
    # 将 Windows Agent 暂存数据的本地路径改为纯 Windows 路径格式，避免出现类似 /home/.../F:/ 这样的怪异路径
